...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($uploadOk == 0) {
        ...
        if (move_uploaded_file($_FILES["productImage"]["tmp_name"], $targetFile)) {
            ...
            $insertQuery = "INSERT INTO products (productName, productPrice, quantity, image ,category) 
                            VALUES ('$productName', '$productPrice', '$quantity', '$imagePath','$category')";
